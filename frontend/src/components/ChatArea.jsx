...
function ChatArea(props) {
    ...
    return (
        <Container className="d-flex flex-column ml-5" style={{ height: "100%" }}>
            <Container ref={chatInfo} id="act-chat" className="d-flex" data-second-user={props.person.second_user} data-chat-id={props.person.chatId} data-user={props.person.user}>
                ...
                <Container className="d-flex align-items-center" style={{width:"fit-content"}}>
                    <Image src="./img/video.svg" className="mx-3 ms-0" style={{marginLeft:"0px"}} height="34px"/>
            ...
            <Container className="d-flex">
                <Container className="d-flex" style={{ flexGrow: "1", marginLeft:"20px" }}>
                ...
                >
                    <Image height="34px" src="./img/clip.svg"/>
                    <Image height="34px" src="./img/send.svg" onClick={sendMessage}/>
                </Container>
            </Container>
        </Container>
    );
